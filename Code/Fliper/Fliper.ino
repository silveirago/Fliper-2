...
/////////////////////////////////////////////
// POTENCIOMETROS
const int N_POTS = 4; //* número total de pots (slide e rotativo)
const int POT_ARDUINO_PIN[N_POTS] = {A3, A2, A1, A0}; //* pinos de cada pot conectado diretamente ao Arduino
